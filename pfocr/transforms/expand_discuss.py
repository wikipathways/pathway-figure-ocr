...
# grep -P "\&\ .*\=\>" successes.txt #space split handles most of these
# grep -P "\ and\ " successes.txt #space split handles most of these
# grep -P "\ or\ " successes.txt #space split handles most of these
# grep -P "[↑→↓←]" successes.txt #space split and alphanum handles most of these
